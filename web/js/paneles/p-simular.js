...
{
    $("#modalEdicionSimulacionTitle").html('<span class="glyphicon glyphicon-plus-sign"></span>  Nueva simulación');
...
function changeMostrarRentSug()
{
    ...
    var idTipoFondo = $("input[name='rbTipoFondo']:checked").val();
    if (idTipoFondo != null) {
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.msj.hayMensaje != true) {
                    $("#txtRentabilidadProbable").val(data.rentabilidad);
                } else
                {
...
function changeUsarRentSug()
{
    if ($("#chRentSug").is(":checked")) {
        $("#txtRentabilidadProbable").attr("readonly", true);
    } else
        $("#txtRentabilidadProbable").attr("readonly", false);
}
